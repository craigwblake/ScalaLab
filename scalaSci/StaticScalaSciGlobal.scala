...
final def solve(A: scalaSci.CCMatrix, b: Array[Double]) = {
  ...
  final def solve(A: Array[Array[Double]],  b: Array[Array[Double]]) = {
   LinearAlgebra.solve( A, b)
}


final def solve(A: RichDouble2DArray,  b: RichDouble2DArray) = {
   new RichDouble2DArray(LinearAlgebra.solve( A.getv, b.getv))
}
