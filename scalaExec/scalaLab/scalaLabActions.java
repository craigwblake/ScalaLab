...
class groovySciPlottingExamplesJTreeAction extends AbstractAction {
       groovySciPlottingExamplesJTreeAction() {
           super("groovySci Plotting  Examples with JTree displaying");
       }

    public void actionPerformed(ActionEvent e) {
        scalaExec.gui.watchExamples weObj = new scalaExec.gui.watchExamples();
        weObj.scanMainJarFile(".plots-gsci");
        weObj.displayExamples("GroovySci Plotting Examples");
