...
public class ProcessPlottingVisADExamplesInJar  extends JFrame {
...
*/
   ...
   public ProcessPlottingVisADExamplesInJar(String jarFile)
   {
      setTitle("VisAD Plotting Visualization Examples -- For Java examples, Copy & Paste in the ScalaLab Editor and then press F9 to run them");
