...
public class ProcessPlottingVisADExamplesJavaInJar  extends JFrame {
...
*/
   ...
   public ProcessPlottingVisADExamplesJavaInJar(String jarFile)
   {
      setTitle("VisAD Plotting Visualization Examples -- For Java examples, Copy & Paste in the ScalaInterpreterPane and then press F9 to run them");
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".javaVISAD")) 
