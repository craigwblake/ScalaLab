...
public class scalaLab extends JFrame implements WindowListener, ActionListener
{
    ...
    public  scalalabConsole scalalabConsole;
    ...
    public  String  fileWithFileListOfPaneRecentFiles = "recentsPaneFile.txt"; // the list of the recent editor's pane files
     ...
     private JMenuItem displayCurrentAbbreviationsJMenuItem;
     private JMenuItem displayScalaSciVariables;
     private JMenuItem fastScriptTemplateJMenuItem;
    ...
    private void initHelpObjects() {
        ...
        public void closeGUI()
        {
          ...
          scalaExec.Interpreter.ControlGroovy.groovyLabClose(scalaExec.Interpreter.ControlGroovy.groovyLabSettings);
...
ejmlConfig.setToolTipText("Settings that can affect performance of the EJML library");
        ...
        scalaExec.gui.WatchClasses  watchClassesOfScalaSci = new scalaExec.gui.WatchClasses();
         ...
         watchClassesOfScalaSci.displayClassesAndMethodsAsString(coltClasses, "CERN Colt  ", filterString,  scalaExec.gui.WatchClasses.watchXLoc+k*50, scalaExec.gui.WatchClasses.watchYLoc+k*50);
                ...
                confMenuGroovy = new JMenu("ConfigurationGroovy");
                confMenuGroovy.setFont(scalaExec.Interpreter.GlobalValues.uifont);
                confMenuGroovy.setToolTipText("configurations for the Groovy run time environment");
                
                       
                 controlIndyJMenuItem = new JMenuItem("Toggle INDY - Current state is  "+gExec.Interpreter.GlobalValues.CompileIndy);
                 controlIndyJMenuItem.setFont(scalaExec.Interpreter.GlobalValues.uifont);
                ...
                controlIndyJMenuItem.addActionListener(new ActionListener() {
                    ...
                    @Override
                    public void actionPerformed(ActionEvent e) {
                     gExec.Interpreter.GlobalValues.GroovyShell = null;
                     gExec.Interpreter.GlobalValues.CompileIndy = !gExec.Interpreter.GlobalValues.CompileIndy;
                     controlIndyJMenuItem.setText("Toggle INDY - Current state is  "+gExec.Interpreter.GlobalValues.CompileIndy);
                    }
                });
                
                
                controlDefaultlmportsJMenuItem = new JMenuItem("Toggle useAlwaysDefaultImports - Current state is  "+gExec.Interpreter.GlobalValues.useAlwaysDefaultImports);
                 controlDefaultlmportsJMenuItem.setFont(scalaExec.Interpreter.GlobalValues.uifont);
                ...
                controlDefaultlmportsJMenuItem.addActionListener(new ActionListener() {
                    ...
                    @Override
                    public void actionPerformed(ActionEvent e) {
                     gExec.Interpreter.GlobalValues.useAlwaysDefaultImports = !gExec.Interpreter.GlobalValues.useAlwaysDefaultImports;
                     gExec.Interpreter.GlobalValues.GroovyShell = null;  // force the creation of a new GroovyShell 
                     controlDefaultlmportsJMenuItem.setText("Toggle useAlwaysDefaultImports - Current state is  "+gExec.Interpreter.GlobalValues.useAlwaysDefaultImports);
                    }
                });
                
                
                 final JMenuItem controlDecimalsToDoublesJMenuItem = new JMenuItem("Transforms BigDecimals to Doubles - Current state is  "+gExec.Interpreter.GlobalValues.CompileDecimalsToDoubles);
                 controlDecimalsToDoublesJMenuItem.setFont(scalaExec.Interpreter.GlobalValues.uifont);
                ...
                controlDecimalsToDoublesJMenuItem.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                     gExec.Interpreter.GlobalValues.GroovyShell = null;
                     gExec.Interpreter.GlobalValues.CompileDecimalsToDoubles  = !gExec.Interpreter.GlobalValues.CompileDecimalsToDoubles;
                     controlDecimalsToDoublesJMenuItem.setText("Toggle transform BigDecimals to doubles- Current state is  "+gExec.Interpreter.GlobalValues.CompileDecimalsToDoubles);
                    }
                });
                
          JMenuItem resetGroovyShellJMenuItem = new JMenuItem("Reset Groovy Shell context");
                resetGroovyShellJMenuItem.setFont(GlobalValues.uifont);
                resetGroovyShellJMenuItem.setToolTipText("Clears both variable bindings and loaded classes");
                resetGroovyShellJMenuItem.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
          gExec.Interpreter.GlobalValues.GroovyShell.resetLoadedClasses();
          gExec.Interpreter.GlobalValues.GroovyShell.getContext().getVariables().clear();
            }
        });
          
                JMenuItem newGroovyShellJMenuItem = new JMenuItem("New Groovy Shell using the current toolboxes");
                newGroovyShellJMenuItem.setFont(GlobalValues.uifont);
                newGroovyShellJMenuItem.setToolTipText("Creates a new Groovy Shell using the specified toolboxes for ScalaSci (i.e. Scala Interpreter and Groovy Shell share the same toolboxes) ");
                newGroovyShellJMenuItem.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
          gExec.Interpreter.GlobalValues.GroovyShell = null;  // new GroovyShell creation is deferred for the next command execution
                   }
        });
          
        JMenu groovyImportsMenu = new JMenu("GroovyImports");
        groovyImportsMenu.setFont(GlobalValues.uifont);
        groovyImportsMenu.setToolTipText("Groovy Shell does not remember previous import statements and compiled code, thus we can buffer them for automatic inclusion");
        
        JMenuItem bufferImportsJMenuItem = new JMenuItem("Buffer selected imports");
    ...
    bufferImportsJMenuItem.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
           String selectedImports = scalaExec.Interpreter.GlobalValues.editorPane.getSelectedText();
           scalaExec.Interpreter.ControlGroovy.bufferingImports = scalaExec.Interpreter.ControlGroovy.bufferingImports +"\n"+selectedImports;
            }
        });
    
     JMenuItem  codeBufferingMenuItem = new JMenuItem("Buffer code");
     ...
     codeBufferingMenuItem.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
           String selectedCode = scalaExec.Interpreter.GlobalValues.editorPane.getSelectedText();
           scalaExec.Interpreter.ControlGroovy.bufferingCode  = scalaExec.Interpreter.ControlGroovy.bufferingCode+"\n"+selectedCode;
          
            }
        });
   
        JMenuItem editBufferedImportsJMenuItem = new JMenuItem(new scalaExec.Interpreter.editBufferedImportsAction());
        editBufferedImportsJMenuItem.setFont(GlobalValues.uifont);
        
        JMenuItem editBufferedCodeJMenuItem = new JMenuItem(new scalaExec.Interpreter.editBufferedCodeAction());
        editBufferedCodeJMenuItem.setFont(GlobalValues.uifont);
        
        JMenuItem clearBufferedImportsJMenuItem = new JMenuItem("Clear buffered Imports");
        clearBufferedImportsJMenuItem.setFont(GlobalValues.guifont);
        clearBufferedImportsJMenuItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
           scalaExec.Interpreter.ControlGroovy.bufferingImports  = "";
        }
        });
        
        JMenuItem clearCodeBufferingMenuItem  = new JMenuItem("Clear buffered Code");
        clearCodeBufferingMenuItem.setFont(GlobalValues.guifont);
        ...
        groovyImportsMenu.add(bufferImportsJMenuItem);
        groovyImportsMenu.add(codeBufferingMenuItem);
        groovyImportsMenu.add(editBufferedImportsJMenuItem);
        groovyImportsMenu.add(editBufferedCodeJMenuItem);
        groovyImportsMenu.add(clearBufferedImportsJMenuItem);
        groovyImportsMenu.add(clearCodeBufferingMenuItem);
    ...
    clearCodeBufferingMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                confMenuGroovy.add(newGroovyShellJMenuItem);
        ...
        JMenuItem GroovySciExamplesJTreeJMenuItem = new JMenuItem("GroovySci  Examples with JTree display (execute with GroovySci mode, i.e. F8 )");
        GroovySciExamplesJTreeJMenuItem.addActionListener(new groovySciExamplesJTreeAction());
        GroovySciExamplesJTreeJMenuItem.setFont(GlobalValues.uifont);
        
        
        JMenuItem GroovySciPlotExamplesJTreeJMenuItem = new JMenuItem("GroovySci  Plotting Examples with JTree display  (execute with GroovySci mode, i.e. F8 )");
        GroovySciPlotExamplesJTreeJMenuItem.addActionListener(new groovySciPlottingExamplesJTreeAction());
        GroovySciPlotExamplesJTreeJMenuItem.setFont(GlobalValues.uifont);
        ...
        examplesMenu.add(GroovySciExamplesJTreeJMenuItem);
        examplesMenu.add(GroovySciPlotExamplesJTreeJMenuItem);
  ...
  new basicCommandsHelper();
     ...
     public void actionPerformed(java.awt.event.ActionEvent evt) {
             ...
             scalaCellsMenu.add(openScalaCellsJMenuItem);
                ...
                mainJMenuBar.add(groovyImportsMenu);
  ...
  try {
        ...
        if (vers.compareTo("1.5") < 0) {
         ...
         GlobalValues.initGlobals();
          ...
          scalaExec.Interpreter.ControlGroovy.passPropertiesFromSettingsToWorkspace(scalaExec.Interpreter.ControlGroovy.groovyLabSettings);
            
          final scalaLab myGui = new scalaLab(GlobalValues.ScalaSciClassPath, additionalToolboxes);

          scalaExec.Interpreter.ControlGroovy.warmUpGroovy();
