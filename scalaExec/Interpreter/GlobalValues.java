...
public class GlobalValues
{
    ...
    static public   String  scalalabBuildVersion = "26- July-14";
...
// variables for ScalaLab - MatLab interface
    ...
    static public MatlabProxy proxy = null; 
        ...
        // variables for SclalaLab - SciLab interface
    ...
    static public   double  multithreadingOpLimit  = 500.0;  // a matrix with more elements than this, is conidered large, thus use multithreading at RichDouble2DArray multiplication
   ...
   static public int maxItemsToDisplayAtCompletions = 15;
    ...
    static public String [] targetSetting = {"jvm-1.5", "jvm-1.5-fjbg", "jvm-1.5-asm", "jvm-1.6", "jvm-1.7"};
    static public int currentTargetSelectionIndex = 4; 
...
// for retrieving Matlab .mat file variables
   ...
   static public boolean mainToolbarVisible = false;
    ...
    static public  CSHObject  ScalaCSHObject = null;
     ...
     // some variables used for passing bindings from the GroovyShell to the Scala interpreter
    static public double [] doubleArrayValForBinding;
    static public double [][]  double2DArrayValForBinding;
    static public scalaSci.RichDouble2DArray  groovySciMatrixForBinding;
    static public scalaSci.Vec  groovySciVecForBinding;  // GroovySci Vector for binding
    ...
    public static String TITLE="ScalaLab - based on Scala "+scala.tools.nsc.Properties.versionString()+" with GroovyLab functionality,  library type: ";
    ...
    public static void passPropertiesFromSettingsToWorkspace(Properties settings)
     {
        ...
        System.out.println("You do not have CUDA installed properly, CUDA_PATH is null. Therefore, we cannot activate CUDA related operations");
         ...
         if (mulMultithreadingLimitPropSetting != null) {
             GlobalValues.mulMultithreadingLimit =Double.parseDouble(mulMultithreadingLimitPropSetting);
         }
         else {
             double  matrixSizeForMultithreading = scalaSci.StaticMaths.computeProperMatrixSizeThresholdForMultithreading();
             GlobalValues.mulMultithreadingLimit = 1.0*matrixSizeForMultithreading*matrixSizeForMultithreading*matrixSizeForMultithreading;
    ...
    public static void passPropertiesFromWorkspaceToSettings(Properties settings)
     {
         ...
         settings.setProperty("mulMultithreadingLimitProp", Double.toString(GlobalValues.mulMultithreadingLimit));
