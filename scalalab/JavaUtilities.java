...
public class JavaUtilities {
    ...
    JavaGlobals.groovyLabFile = jarPathOfClass("groovySci.math.array.Matrix").toString().replace("file:/", "/");
    ...
    JavaGlobals.groovyLabFile = jarPathOfClass("groovySci.math.array.Matrix").toString().replace("file:/", "");
          ...
          System.out.println("Groovy File = "+JavaGlobals.groovyJarFile);
          System.out.println("GroovyLab Fle = "+JavaGlobals.groovyLabFile);
