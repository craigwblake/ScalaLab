            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JTextArea helpArea = new JTextArea(
                        "   F6:  execute selected ScalaSci text  or current line (with a seperate thread) . \n "+
                                ...
                                "   F8:  execute selected GroovySci text  or current line (with a seperate thread) . \n "+
                                "  Shift-F6:  execute selected GroovySci text  or current line (within the Event Dispatch Thread) . \n "+
